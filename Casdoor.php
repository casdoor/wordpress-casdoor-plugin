...
class Casdoor
{
    ...
    protected $default_settings = [
        ...
        // New option: default off (sslverify stays false unless forced)
        'force_ssl_verify'     => 0,
    ];
    ...
    public function __construct()
    {
        ...
        // IMPORTANT: Hook logout() so Casdoor logout runs on WordPress logout
        add_action('wp_logout', [$this, 'logout'], 99);
    }
    ...
    public function setup()
    {
        ...
        if (!isset($options['backend'])) {
            ...
            // Merge in new defaults (e.g., force_ssl_verify) without overwriting existing values
            $updated = array_merge($this->default_settings, (array) $options);
            if ($updated !== $options) {
                update_option('casdoor_options', $updated);
            }
        }
        $this->install();
    }
